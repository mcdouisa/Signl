    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 py-12 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Student Survey</h1>
          <p className="text-gray-600">Help us identify top talent at your university</p>
        </div>
              ...
              {formData.nominations.map((nomination, index) => (
                <div key={index} className="p-6 border-2 border-gray-200 rounded-xl space-y-4">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-semibold text-gray-900">Nomination #{index + 1}</h3>
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                <h3 className="font-semibold text-gray-900 mb-4">Your Nominations ({formData.nominations.length})</h3>
                <div className="space-y-3">
                  {formData.nominations.map((nom, index) => (
                    <div key={index} className="bg-white p-4 rounded-lg border border-gray-200">
                      <p className="font-semibold text-gray-900">{nom.name}</p>
                      {nom.email && <p className="text-sm text-gray-600">{nom.email}</p>}
                      {nom.major && <p className="text-sm text-gray-600">{nom.major}</p>}
                      <p className="text-sm text-gray-700 mt-2">{nom.reason}</p>
                    </div>
                  ))}
                </div>
              </div>
