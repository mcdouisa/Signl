...
export default function CompanyDashboard() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <nav className="bg-white/[0.04] border border-white/[0.08]-sm">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Peer-Validated Talent</h1>
          <p className="text-gray-400">Browse top students validated by their classmates</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-xl p-6">
            <div className="text-2xl font-bold text-blue-400 mb-1">{requestedIntros.length}</div>
            <div className="text-sm text-gray-400">Introductions Requested</div>
          </div>
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-xl p-6">
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-xl p-6">
            ...
            <div className="text-sm text-gray-400">Hires Remaining</div>
          </div>
        </div>
        ...
        <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-xl p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <select className="px-4 py-2 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg">
