    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center px-6">
        <div className="max-w-2xl w-full bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-2xl p-8 text-center">
          ...
          <p className="text-lg font-semibold text-blue-400 mb-8">
            {email}
          </p>
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6 mb-6 text-left">
            <p className="text-blue-200 font-semibold mb-2">📧 Next Steps:</p>
            <ol className="text-blue-300 text-sm space-y-2 ml-4 list-decimal">
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex items-center justify-center px-6 py-20">
        <div className="max-w-2xl w-full">
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-2xl p-8 mb-6">
            <div className="mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg"
          ...
          <div className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-xl p-6">
            <h3 className="font-semibold text-white mb-3">Why email verification?</h3>
