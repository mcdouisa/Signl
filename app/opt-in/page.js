    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading your nomination...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-semibold text-gray-300">Step {step} of 3</span>
        ...
        <form onSubmit={handleSubmit} className="bg-white/[0.04] backdrop-blur-md border border-white/[0.08] rounded-2xl p-8">
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Email (verified)</label>
                <input type="email" value={studentData.email} disabled className="w-full px-4 py-3 bg-white/5 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Phone Number *</label>
                <input type="tel" name="phone" value={profileData.phone} onChange={handleChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="(555) 123-4567" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">LinkedIn URL *</label>
                <input type="url" name="linkedin" value={profileData.linkedin} onChange={handleChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="linkedin.com/in/yourname" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">GitHub/Portfolio URL (optional)</label>
                <input type="url" name="github" value={profileData.github} onChange={handleChange} className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="github.com/username" />
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <input type="number" step="0.01" min="0" max="4.0" name="gpa" value={profileData.gpa} onChange={handleChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="3.75" />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Career Interests *</label>
                <input type="text" name="careerInterests" value={profileData.careerInterests} onChange={handleChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Software Engineering, Product Management..." />
              </div>

              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Select up to 5 of your top skills *</label>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {allSkills.map(skill => (
                    <button key={skill} type="button" onClick={() => toggleSkill(skill)} className={`px-3 py-2 rounded-lg text-sm font-semibold transition-all ${profileData.skills.includes(skill) ? 'bg-blue-600 text-white' : 'bg-white/10 text-gray-300 hover:bg-white/10'}`}>
                      {skill}
                    </button>
                  ))}
                </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">Short Bio (optional)</label>
                <textarea name="bio" value={profileData.bio} onChange={handleChange} rows={4} className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Tell companies about yourself, your projects, and what you're passionate about..."></textarea>
              </div>

              <div className="flex gap-4">
                <button type="button" onClick={() => setStep(1)} className="flex-1 bg-white/10 text-gray-300 px-6 py-3 rounded-lg font-semibold hover:bg-white/15">Back</button>
          ...
          {step === 3 && (
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-300 mb-2">When are you available to start? *</label>
                <select name="availability" value={profileData.availability} onChange={handleChange} required className="w-full px-4 py-3 bg-white/5 border border-white/10 text-white placeholder:text-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-6">
                <h3 className="font-semibold text-blue-200 mb-2">How Signl Works</h3>
              ...
              <div className="flex gap-4">
                <button type="button" onClick={() => setStep(2)} className="flex-1 bg-white/10 text-gray-300 px-6 py-3 rounded-lg font-semibold hover:bg-white/15">Back</button>
